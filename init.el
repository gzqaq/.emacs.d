...
(use-package emacs
  ...
  (set-face-attribute 'fixed-pitch nil :family "Iosevka" :height 100 :weight 'regular)
  (set-face-attribute 'variable-pitch nil :family "Iosevka Aile" :height 100 :weight 'regular)
  :custom
  (line-spacing 0.2)
